import{c as n}from"./utilidades-6105eef8.js";import{a as r,i as d,r as i,b as s}from"./menuCarrinho-fefade57.js";function c(){for(const o of n){const e=`<div class='border-solid w-48 m-2 flex flex-col p-2 justify-between shadow-xl shadow-slate-400 rounded-lg group ${o.bebida?"bebida":"acompanhamento"}' id="card-produto-${o.id}">
        <img
